...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.w13p1'
        db.add_column('mydata_source1', 'w13p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w13p2'
        db.add_column('mydata_source1', 'w13p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w14p1'
        db.add_column('mydata_source1', 'w14p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w14p2'
        db.add_column('mydata_source1', 'w14p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w15p1'
        db.add_column('mydata_source1', 'w15p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w15p2'
        db.add_column('mydata_source1', 'w15p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w16p1'
        db.add_column('mydata_source1', 'w16p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w16p2'
        db.add_column('mydata_source1', 'w16p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.w13p1'
        db.delete_column('mydata_source1', 'w13p1')

        # Deleting field 'Source1.w13p2'
        db.delete_column('mydata_source1', 'w13p2')

        # Deleting field 'Source1.w14p1'
        db.delete_column('mydata_source1', 'w14p1')

        # Deleting field 'Source1.w14p2'
        db.delete_column('mydata_source1', 'w14p2')

        # Deleting field 'Source1.w15p1'
        db.delete_column('mydata_source1', 'w15p1')

        # Deleting field 'Source1.w15p2'
        db.delete_column('mydata_source1', 'w15p2')

        # Deleting field 'Source1.w16p1'
        db.delete_column('mydata_source1', 'w16p1')

        # Deleting field 'Source1.w16p2'
        db.delete_column('mydata_source1', 'w16p2')
    ...
    models = {
        ...
        'mydata17.source1': {
            ...
            'Compare_Goal_Grade_GPA': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'GPA_Conversion': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'Python_PreExam_2': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'Python_PreExam_3': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'Reg_Section': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'w10p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w10p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w11p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w11p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w12p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w12p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w13p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w13p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w14p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w14p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w15p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w15p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w16p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w16p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'w5p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w5p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w6p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w6p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w7p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w7p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w8p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w8p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w9p1': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'w9p2': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        }
    }
