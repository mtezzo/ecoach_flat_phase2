...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Python_PreExam_2'
        db.add_column('mydata_source1', 'Python_PreExam_2',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Python_PreExam_3'
        db.add_column('mydata_source1', 'Python_PreExam_3',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w9p1'
        db.add_column('mydata_source1', 'w9p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w9p2'
        db.add_column('mydata_source1', 'w9p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w10p1'
        db.add_column('mydata_source1', 'w10p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w10p2'
        db.add_column('mydata_source1', 'w10p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w11p1'
        db.add_column('mydata_source1', 'w11p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w11p2'
        db.add_column('mydata_source1', 'w11p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w12p1'
        db.add_column('mydata_source1', 'w12p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w12p2'
        db.add_column('mydata_source1', 'w12p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Python_PreExam_2'
        db.delete_column('mydata_source1', 'Python_PreExam_2')

        # Deleting field 'Source1.Python_PreExam_3'
        db.delete_column('mydata_source1', 'Python_PreExam_3')

        # Deleting field 'Source1.w9p1'
        db.delete_column('mydata_source1', 'w9p1')

        # Deleting field 'Source1.w9p2'
        db.delete_column('mydata_source1', 'w9p2')

        # Deleting field 'Source1.w10p1'
        db.delete_column('mydata_source1', 'w10p1')

        # Deleting field 'Source1.w10p2'
        db.delete_column('mydata_source1', 'w10p2')

        # Deleting field 'Source1.w11p1'
        db.delete_column('mydata_source1', 'w11p1')

        # Deleting field 'Source1.w11p2'
        db.delete_column('mydata_source1', 'w11p2')

        # Deleting field 'Source1.w12p1'
        db.delete_column('mydata_source1', 'w12p1')

        # Deleting field 'Source1.w12p2'
        db.delete_column('mydata_source1', 'w12p2')
