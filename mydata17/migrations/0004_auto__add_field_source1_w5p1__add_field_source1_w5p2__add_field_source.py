...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.w5p1'
        db.add_column('mydata_source1', 'w5p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w5p2'
        db.add_column('mydata_source1', 'w5p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w6p1'
        db.add_column('mydata_source1', 'w6p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w6p2'
        db.add_column('mydata_source1', 'w6p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w7p1'
        db.add_column('mydata_source1', 'w7p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w7p2'
        db.add_column('mydata_source1', 'w7p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w8p1'
        db.add_column('mydata_source1', 'w8p1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.w8p2'
        db.add_column('mydata_source1', 'w8p2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.w5p1'
        db.delete_column('mydata_source1', 'w5p1')

        # Deleting field 'Source1.w5p2'
        db.delete_column('mydata_source1', 'w5p2')

        # Deleting field 'Source1.w6p1'
        db.delete_column('mydata_source1', 'w6p1')

        # Deleting field 'Source1.w6p2'
        db.delete_column('mydata_source1', 'w6p2')

        # Deleting field 'Source1.w7p1'
        db.delete_column('mydata_source1', 'w7p1')

        # Deleting field 'Source1.w7p2'
        db.delete_column('mydata_source1', 'w7p2')

        # Deleting field 'Source1.w8p1'
        db.delete_column('mydata_source1', 'w8p1')

        # Deleting field 'Source1.w8p2'
        db.delete_column('mydata_source1', 'w8p2')
