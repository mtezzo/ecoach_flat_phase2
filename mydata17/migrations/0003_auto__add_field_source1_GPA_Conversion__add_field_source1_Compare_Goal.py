...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.GPA_Conversion'
        db.add_column('mydata_source1', 'GPA_Conversion',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Compare_Goal_Grade_GPA'
        db.add_column('mydata_source1', 'Compare_Goal_Grade_GPA',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.GPA_Conversion'
        db.delete_column('mydata_source1', 'GPA_Conversion')

        # Deleting field 'Source1.Compare_Goal_Grade_GPA'
        db.delete_column('mydata_source1', 'Compare_Goal_Grade_GPA')
