...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Source1.Pred_Grade_Initial'
        db.delete_column('mydata_source1', 'Pred_Grade_Initial')

        # Adding field 'Source1.Pred_Grade_Initial_135'
        db.add_column('mydata_source1', 'Pred_Grade_Initial_135',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Pred_Grade_Initial_235'
        db.add_column('mydata_source1', 'Pred_Grade_Initial_235',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Pred_Grade_Initial_140'
        db.add_column('mydata_source1', 'Pred_Grade_Initial_140',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Pred_Grade_Initial_240'
        db.add_column('mydata_source1', 'Pred_Grade_Initial_240',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Distribution_ID_135'
        db.add_column('mydata_source1', 'Distribution_ID_135',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Distribution_ID_235'
        db.add_column('mydata_source1', 'Distribution_ID_235',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Distribution_ID_140'
        db.add_column('mydata_source1', 'Distribution_ID_140',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Distribution_ID_240'
        db.add_column('mydata_source1', 'Distribution_ID_240',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Source1.Pred_Grade_Initial'
        db.add_column('mydata_source1', 'Pred_Grade_Initial',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Source1.Pred_Grade_Initial_135'
        db.delete_column('mydata_source1', 'Pred_Grade_Initial_135')

        # Deleting field 'Source1.Pred_Grade_Initial_235'
        db.delete_column('mydata_source1', 'Pred_Grade_Initial_235')

        # Deleting field 'Source1.Pred_Grade_Initial_140'
        db.delete_column('mydata_source1', 'Pred_Grade_Initial_140')

        # Deleting field 'Source1.Pred_Grade_Initial_240'
        db.delete_column('mydata_source1', 'Pred_Grade_Initial_240')

        # Deleting field 'Source1.Distribution_ID_135'
        db.delete_column('mydata_source1', 'Distribution_ID_135')

        # Deleting field 'Source1.Distribution_ID_235'
        db.delete_column('mydata_source1', 'Distribution_ID_235')

        # Deleting field 'Source1.Distribution_ID_140'
        db.delete_column('mydata_source1', 'Distribution_ID_140')

        # Deleting field 'Source1.Distribution_ID_240'
        db.delete_column('mydata_source1', 'Distribution_ID_240')
