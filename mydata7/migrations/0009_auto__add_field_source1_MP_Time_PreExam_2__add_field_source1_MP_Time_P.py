...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.MP_Time_PreExam_2'
        db.add_column('mydata_source1', 'MP_Time_PreExam_2',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.MP_Time_PreExam_3'
        db.add_column('mydata_source1', 'MP_Time_PreExam_3',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.ProblemRoulette_PreExam_2'
        db.add_column('mydata_source1', 'ProblemRoulette_PreExam_2',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.ProblemRoulette_Time_PreExam_2'
        db.add_column('mydata_source1', 'ProblemRoulette_Time_PreExam_2',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.ProblemRoulette_PreExam_3'
        db.add_column('mydata_source1', 'ProblemRoulette_PreExam_3',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.ProblemRoulette_Time_PreExam_3'
        db.add_column('mydata_source1', 'ProblemRoulette_Time_PreExam_3',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.MP_Time_PreExam_2'
        db.delete_column('mydata_source1', 'MP_Time_PreExam_2')

        # Deleting field 'Source1.MP_Time_PreExam_3'
        db.delete_column('mydata_source1', 'MP_Time_PreExam_3')

        # Deleting field 'Source1.ProblemRoulette_PreExam_2'
        db.delete_column('mydata_source1', 'ProblemRoulette_PreExam_2')

        # Deleting field 'Source1.ProblemRoulette_Time_PreExam_2'
        db.delete_column('mydata_source1', 'ProblemRoulette_Time_PreExam_2')

        # Deleting field 'Source1.ProblemRoulette_PreExam_3'
        db.delete_column('mydata_source1', 'ProblemRoulette_PreExam_3')

        # Deleting field 'Source1.ProblemRoulette_Time_PreExam_3'
        db.delete_column('mydata_source1', 'ProblemRoulette_Time_PreExam_3')
