...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.FCI_PreTest'
        db.add_column('mydata_source1', 'FCI_PreTest',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FCI_PostTest'
        db.add_column('mydata_source1', 'FCI_PostTest',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PreMathTest'
        db.add_column('mydata_source1', 'PreMathTest',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.redo_exam1'
        db.add_column('mydata_source1', 'redo_exam1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.redo_exam2'
        db.add_column('mydata_source1', 'redo_exam2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.redo_exam3'
        db.add_column('mydata_source1', 'redo_exam3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_ECoach_StudyHabits'
        db.add_column('mydata_source1', 'FeedbackExam1_ECoach_StudyHabits',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_ECoach_ExamPrep'
        db.add_column('mydata_source1', 'FeedbackExam1_ECoach_ExamPrep',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_ECoach_Helpful'
        db.add_column('mydata_source1', 'FeedbackExam1_ECoach_Helpful',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_ECoach_Change'
        db.add_column('mydata_source1', 'FeedbackExam1_ECoach_Change',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_StudyGroup_Attend'
        db.add_column('mydata_source1', 'FeedbackExam1_StudyGroup_Attend',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_StudyGroup_New'
        db.add_column('mydata_source1', 'FeedbackExam1_StudyGroup_New',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_StudyGroup_Helpful'
        db.add_column('mydata_source1', 'FeedbackExam1_StudyGroup_Helpful',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_StudyGroup_Change'
        db.add_column('mydata_source1', 'FeedbackExam1_StudyGroup_Change',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PhysicsHelpRoom_Attend'
        db.add_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Attend',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PhysicsHelpRoom_Reason'
        db.add_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Reason',
                      self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PhysicsHelpRoom_Reason_Other'
        db.add_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Reason_Other',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PhysicsHelpRoom_Helpful'
        db.add_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Helpful',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PhysicsHelpRoom_Change'
        db.add_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Change',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam1_PeerAdvice'
        db.add_column('mydata_source1', 'FeedbackExam1_PeerAdvice',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.FCI_PreTest'
        db.delete_column('mydata_source1', 'FCI_PreTest')

        # Deleting field 'Source1.FCI_PostTest'
        db.delete_column('mydata_source1', 'FCI_PostTest')

        # Deleting field 'Source1.PreMathTest'
        db.delete_column('mydata_source1', 'PreMathTest')

        # Deleting field 'Source1.redo_exam1'
        db.delete_column('mydata_source1', 'redo_exam1')

        # Deleting field 'Source1.redo_exam2'
        db.delete_column('mydata_source1', 'redo_exam2')

        # Deleting field 'Source1.redo_exam3'
        db.delete_column('mydata_source1', 'redo_exam3')

        # Deleting field 'Source1.FeedbackExam1_ECoach_StudyHabits'
        db.delete_column('mydata_source1', 'FeedbackExam1_ECoach_StudyHabits')

        # Deleting field 'Source1.FeedbackExam1_ECoach_ExamPrep'
        db.delete_column('mydata_source1', 'FeedbackExam1_ECoach_ExamPrep')

        # Deleting field 'Source1.FeedbackExam1_ECoach_Helpful'
        db.delete_column('mydata_source1', 'FeedbackExam1_ECoach_Helpful')

        # Deleting field 'Source1.FeedbackExam1_ECoach_Change'
        db.delete_column('mydata_source1', 'FeedbackExam1_ECoach_Change')

        # Deleting field 'Source1.FeedbackExam1_StudyGroup_Attend'
        db.delete_column('mydata_source1', 'FeedbackExam1_StudyGroup_Attend')

        # Deleting field 'Source1.FeedbackExam1_StudyGroup_New'
        db.delete_column('mydata_source1', 'FeedbackExam1_StudyGroup_New')

        # Deleting field 'Source1.FeedbackExam1_StudyGroup_Helpful'
        db.delete_column('mydata_source1', 'FeedbackExam1_StudyGroup_Helpful')

        # Deleting field 'Source1.FeedbackExam1_StudyGroup_Change'
        db.delete_column('mydata_source1', 'FeedbackExam1_StudyGroup_Change')

        # Deleting field 'Source1.FeedbackExam1_PhysicsHelpRoom_Attend'
        db.delete_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Attend')

        # Deleting field 'Source1.FeedbackExam1_PhysicsHelpRoom_Reason'
        db.delete_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Reason')

        # Deleting field 'Source1.FeedbackExam1_PhysicsHelpRoom_Reason_Other'
        db.delete_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Reason_Other')

        # Deleting field 'Source1.FeedbackExam1_PhysicsHelpRoom_Helpful'
        db.delete_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Helpful')

        # Deleting field 'Source1.FeedbackExam1_PhysicsHelpRoom_Change'
        db.delete_column('mydata_source1', 'FeedbackExam1_PhysicsHelpRoom_Change')

        # Deleting field 'Source1.FeedbackExam1_PeerAdvice'
        db.delete_column('mydata_source1', 'FeedbackExam1_PeerAdvice')
