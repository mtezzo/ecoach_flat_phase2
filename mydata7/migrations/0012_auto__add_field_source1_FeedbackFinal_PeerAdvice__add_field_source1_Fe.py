...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.FeedbackFinal_PeerAdvice'
        db.add_column('mydata_source1', 'FeedbackFinal_PeerAdvice',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_StudyHabits'
        db.add_column('mydata_source1', 'FeedbackFinal_StudyHabits',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_ExamPrep'
        db.add_column('mydata_source1', 'FeedbackFinal_ExamPrep',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_Helpful'
        db.add_column('mydata_source1', 'FeedbackFinal_Helpful',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_Change'
        db.add_column('mydata_source1', 'FeedbackFinal_Change',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_OtherCourses_YesNo'
        db.add_column('mydata_source1', 'FeedbackFinal_OtherCourses_YesNo',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_OtherCourses_Text'
        db.add_column('mydata_source1', 'FeedbackFinal_OtherCourses_Text',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_Confidence'
        db.add_column('mydata_source1', 'FeedbackFinal_Confidence',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackFinal_Major'
        db.add_column('mydata_source1', 'FeedbackFinal_Major',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.FeedbackFinal_PeerAdvice'
        db.delete_column('mydata_source1', 'FeedbackFinal_PeerAdvice')

        # Deleting field 'Source1.FeedbackFinal_StudyHabits'
        db.delete_column('mydata_source1', 'FeedbackFinal_StudyHabits')

        # Deleting field 'Source1.FeedbackFinal_ExamPrep'
        db.delete_column('mydata_source1', 'FeedbackFinal_ExamPrep')

        # Deleting field 'Source1.FeedbackFinal_Helpful'
        db.delete_column('mydata_source1', 'FeedbackFinal_Helpful')

        # Deleting field 'Source1.FeedbackFinal_Change'
        db.delete_column('mydata_source1', 'FeedbackFinal_Change')

        # Deleting field 'Source1.FeedbackFinal_OtherCourses_YesNo'
        db.delete_column('mydata_source1', 'FeedbackFinal_OtherCourses_YesNo')

        # Deleting field 'Source1.FeedbackFinal_OtherCourses_Text'
        db.delete_column('mydata_source1', 'FeedbackFinal_OtherCourses_Text')

        # Deleting field 'Source1.FeedbackFinal_Confidence'
        db.delete_column('mydata_source1', 'FeedbackFinal_Confidence')

        # Deleting field 'Source1.FeedbackFinal_Major'
        db.delete_column('mydata_source1', 'FeedbackFinal_Major')
