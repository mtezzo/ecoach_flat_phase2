...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.vote_exam1'
        db.add_column('mydata_source1', 'vote_exam1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.vote_exam2'
        db.add_column('mydata_source1', 'vote_exam2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.vote_exam3'
        db.add_column('mydata_source1', 'vote_exam3',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.vote_exam1'
        db.delete_column('mydata_source1', 'vote_exam1')

        # Deleting field 'Source1.vote_exam2'
        db.delete_column('mydata_source1', 'vote_exam2')

        # Deleting field 'Source1.vote_exam3'
        db.delete_column('mydata_source1', 'vote_exam3')
