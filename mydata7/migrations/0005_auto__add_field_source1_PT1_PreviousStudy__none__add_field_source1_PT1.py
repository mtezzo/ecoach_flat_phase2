...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.PT1_PreviousStudy__none'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__none',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__lecturenotes'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__lecturenotes',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__lecturevideos'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__lecturevideos',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__readbook'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__readbook',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__bookprobs'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__bookprobs',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__masteringphysics'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__masteringphysics',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__officehours'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__officehours',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__physicshelproom'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__physicshelproom',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__studygroup'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__studygroup',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__problemroulette'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__problemroulette',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__practiceexam'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__practiceexam',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_PreviousStudy__outsideresource'
        db.add_column('mydata_source1', 'PT1_PreviousStudy__outsideresource',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle_135'
        db.add_column('mydata_source1', 'PT1_ProbStruggle_135',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle_140'
        db.add_column('mydata_source1', 'PT1_ProbStruggle_140',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle_235'
        db.add_column('mydata_source1', 'PT1_ProbStruggle_235',
                      self.gf('django.db.models.fields.CharField')(max_length=23, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle_240'
        db.add_column('mydata_source1', 'PT1_ProbStruggle_240',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbConfident_135'
        db.add_column('mydata_source1', 'PT1_ProbConfident_135',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbConfident_140'
        db.add_column('mydata_source1', 'PT1_ProbConfident_140',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbConfident_235'
        db.add_column('mydata_source1', 'PT1_ProbConfident_235',
                      self.gf('django.db.models.fields.CharField')(max_length=23, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbConfident_240'
        db.add_column('mydata_source1', 'PT1_ProbConfident_240',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbSolvingStep'
        db.add_column('mydata_source1', 'PT1_ProbSolvingStep',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggleImprovedConf'
        db.add_column('mydata_source1', 'PT1_ProbStruggleImprovedConf',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle2_135'
        db.add_column('mydata_source1', 'PT1_ProbStruggle2_135',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle2_140'
        db.add_column('mydata_source1', 'PT1_ProbStruggle2_140',
                      self.gf('django.db.models.fields.CharField')(max_length=14, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle2_235'
        db.add_column('mydata_source1', 'PT1_ProbStruggle2_235',
                      self.gf('django.db.models.fields.CharField')(max_length=23, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ProbStruggle2_240'
        db.add_column('mydata_source1', 'PT1_ProbStruggle2_240',
                      self.gf('django.db.models.fields.CharField')(max_length=17, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ApplyingMath'
        db.add_column('mydata_source1', 'PT1_ApplyingMath',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_ConceptualProbs'
        db.add_column('mydata_source1', 'PT1_ConceptualProbs',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_Notecard'
        db.add_column('mydata_source1', 'PT1_Notecard',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PT1_Timelimit'
        db.add_column('mydata_source1', 'PT1_Timelimit',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.PT1_PreviousStudy__none'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__none')

        # Deleting field 'Source1.PT1_PreviousStudy__lecturenotes'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__lecturenotes')

        # Deleting field 'Source1.PT1_PreviousStudy__lecturevideos'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__lecturevideos')

        # Deleting field 'Source1.PT1_PreviousStudy__readbook'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__readbook')

        # Deleting field 'Source1.PT1_PreviousStudy__bookprobs'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__bookprobs')

        # Deleting field 'Source1.PT1_PreviousStudy__masteringphysics'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__masteringphysics')

        # Deleting field 'Source1.PT1_PreviousStudy__officehours'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__officehours')

        # Deleting field 'Source1.PT1_PreviousStudy__physicshelproom'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__physicshelproom')

        # Deleting field 'Source1.PT1_PreviousStudy__studygroup'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__studygroup')

        # Deleting field 'Source1.PT1_PreviousStudy__problemroulette'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__problemroulette')

        # Deleting field 'Source1.PT1_PreviousStudy__practiceexam'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__practiceexam')

        # Deleting field 'Source1.PT1_PreviousStudy__outsideresource'
        db.delete_column('mydata_source1', 'PT1_PreviousStudy__outsideresource')

        # Deleting field 'Source1.PT1_ProbStruggle_135'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle_135')

        # Deleting field 'Source1.PT1_ProbStruggle_140'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle_140')

        # Deleting field 'Source1.PT1_ProbStruggle_235'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle_235')

        # Deleting field 'Source1.PT1_ProbStruggle_240'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle_240')

        # Deleting field 'Source1.PT1_ProbConfident_135'
        db.delete_column('mydata_source1', 'PT1_ProbConfident_135')

        # Deleting field 'Source1.PT1_ProbConfident_140'
        db.delete_column('mydata_source1', 'PT1_ProbConfident_140')

        # Deleting field 'Source1.PT1_ProbConfident_235'
        db.delete_column('mydata_source1', 'PT1_ProbConfident_235')

        # Deleting field 'Source1.PT1_ProbConfident_240'
        db.delete_column('mydata_source1', 'PT1_ProbConfident_240')

        # Deleting field 'Source1.PT1_ProbSolvingStep'
        db.delete_column('mydata_source1', 'PT1_ProbSolvingStep')

        # Deleting field 'Source1.PT1_ProbStruggleImprovedConf'
        db.delete_column('mydata_source1', 'PT1_ProbStruggleImprovedConf')

        # Deleting field 'Source1.PT1_ProbStruggle2_135'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle2_135')

        # Deleting field 'Source1.PT1_ProbStruggle2_140'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle2_140')

        # Deleting field 'Source1.PT1_ProbStruggle2_235'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle2_235')

        # Deleting field 'Source1.PT1_ProbStruggle2_240'
        db.delete_column('mydata_source1', 'PT1_ProbStruggle2_240')

        # Deleting field 'Source1.PT1_ApplyingMath'
        db.delete_column('mydata_source1', 'PT1_ApplyingMath')

        # Deleting field 'Source1.PT1_ConceptualProbs'
        db.delete_column('mydata_source1', 'PT1_ConceptualProbs')

        # Deleting field 'Source1.PT1_Notecard'
        db.delete_column('mydata_source1', 'PT1_Notecard')

        # Deleting field 'Source1.PT1_Timelimit'
        db.delete_column('mydata_source1', 'PT1_Timelimit')
