...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Final_Course_Grade_Perc'
        db.add_column('mydata_source1', 'Final_Course_Grade_Perc',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Final_Course_Grade_Letter'
        db.add_column('mydata_source1', 'Final_Course_Grade_Letter',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Final_Course_Grade_Perc'
        db.delete_column('mydata_source1', 'Final_Course_Grade_Perc')

        # Deleting field 'Source1.Final_Course_Grade_Letter'
        db.delete_column('mydata_source1', 'Final_Course_Grade_Letter')
