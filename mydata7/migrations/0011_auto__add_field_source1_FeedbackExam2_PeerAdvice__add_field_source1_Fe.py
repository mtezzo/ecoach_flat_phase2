...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.FeedbackExam2_PeerAdvice'
        db.add_column('mydata_source1', 'FeedbackExam2_PeerAdvice',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.FeedbackExam3_PeerAdvice'
        db.add_column('mydata_source1', 'FeedbackExam3_PeerAdvice',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.FeedbackExam2_PeerAdvice'
        db.delete_column('mydata_source1', 'FeedbackExam2_PeerAdvice')

        # Deleting field 'Source1.FeedbackExam3_PeerAdvice'
        db.delete_column('mydata_source1', 'FeedbackExam3_PeerAdvice')
