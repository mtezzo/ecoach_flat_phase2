...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Post_Exam2_Feelings__1'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__1',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Post_Exam2_Feelings__2'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__2',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Post_Exam2_Feelings__3'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__3',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Post_Exam2_Feelings__4'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__4',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Post_Exam2_Feelings__5'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__5',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Post_Exam2_Feelings__6'
        db.add_column('mydata_source1', 'Post_Exam2_Feelings__6',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PR_ProblemsTried_Exam2'
        db.add_column('mydata_source1', 'PR_ProblemsTried_Exam2',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Post_Exam2_Feelings__1'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__1')

        # Deleting field 'Source1.Post_Exam2_Feelings__2'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__2')

        # Deleting field 'Source1.Post_Exam2_Feelings__3'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__3')

        # Deleting field 'Source1.Post_Exam2_Feelings__4'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__4')

        # Deleting field 'Source1.Post_Exam2_Feelings__5'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__5')

        # Deleting field 'Source1.Post_Exam2_Feelings__6'
        db.delete_column('mydata_source1', 'Post_Exam2_Feelings__6')

        # Deleting field 'Source1.PR_ProblemsTried_Exam2'
        db.delete_column('mydata_source1', 'PR_ProblemsTried_Exam2')
