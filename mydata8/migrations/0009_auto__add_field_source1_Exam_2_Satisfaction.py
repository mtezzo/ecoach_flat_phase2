...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Exam_2_Satisfaction'
        db.add_column('mydata_source1', 'Exam_2_Satisfaction',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Exam_2_Satisfaction'
        db.delete_column('mydata_source1', 'Exam_2_Satisfaction')
