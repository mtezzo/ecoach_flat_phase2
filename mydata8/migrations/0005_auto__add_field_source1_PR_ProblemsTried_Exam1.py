...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.PR_ProblemsTried_Exam1'
        db.add_column('mydata_source1', 'PR_ProblemsTried_Exam1',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.PR_ProblemsTried_Exam1'
        db.delete_column('mydata_source1', 'PR_ProblemsTried_Exam1')
