...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('mydata_source1', (
            ...
            ('Permission_To_Use_Exam2_Self_Advice', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('mydata9', ['Source1'])

        # Adding model 'EmptySource'
        db.create_table('mydata9_emptysource', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.related.ForeignKey')(db_column='user_id', on_delete=models.SET_NULL, to_field='username', to=orm['auth.User'], blank=True, null=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('mydata9', ['EmptySource'])
        ...
        db.send_create_signal('mydata9', ['Common1'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('mydata9_emptysource')
