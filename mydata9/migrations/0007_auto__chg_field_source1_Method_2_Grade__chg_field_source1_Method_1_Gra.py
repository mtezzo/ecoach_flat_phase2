...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Source1.Method_2_Grade'
        db.alter_column('mydata_source1', 'Method_2_Grade', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Source1.Method_1_Grade'
        db.alter_column('mydata_source1', 'Method_1_Grade', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Source1.Method_2_Grade'
        db.alter_column('mydata_source1', 'Method_2_Grade', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Source1.Method_1_Grade'
        db.alter_column('mydata_source1', 'Method_1_Grade', self.gf('django.db.models.fields.IntegerField')(null=True))
