...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.ECoach_why_non_user'
        db.add_column('mydata_source1', 'ECoach_why_non_user',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.ECoach_improve_for_non_user'
        db.add_column('mydata_source1', 'ECoach_improve_for_non_user',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.ECoach_why_non_user'
        db.delete_column('mydata_source1', 'ECoach_why_non_user')

        # Deleting field 'Source1.ECoach_improve_for_non_user'
        db.delete_column('mydata_source1', 'ECoach_improve_for_non_user')
    ...
    models = {
        ...
        'mydata19.source1': {
            ...
            'ECoach_improve_for_non_user': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ECoach_why_non_user': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
