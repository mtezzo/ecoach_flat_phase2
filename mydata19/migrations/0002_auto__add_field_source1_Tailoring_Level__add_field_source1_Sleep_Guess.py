...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Tailoring_Level'
        db.add_column('mydata_source1', 'Tailoring_Level',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Sleep_Guess'
        db.add_column('mydata_source1', 'Sleep_Guess',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Tailoring_Level'
        db.delete_column('mydata_source1', 'Tailoring_Level')

        # Deleting field 'Source1.Sleep_Guess'
        db.delete_column('mydata_source1', 'Sleep_Guess')
