...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Source1.Permission_To_Use_Exam1_Self_Advice'
        db.delete_column('mydata_source1', 'Permission_To_Use_Exam1_Self_Advice')

        # Adding field 'Source1.Exam_1_Prep_Resources__0'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__0',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__1'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__1',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__2'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__2',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__3'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__3',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__4'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__4',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__6'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__6',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__7'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__7',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__8'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__8',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__9'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__9',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Resources__10'
        db.add_column('mydata_source1', 'Exam_1_Prep_Resources__10',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Exam_1_Prep_Simulation'
        db.add_column('mydata_source1', 'Exam_1_Prep_Simulation',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Permission_To_Use_Exam_1_Self_Advice'
        db.add_column('mydata_source1', 'Permission_To_Use_Exam_1_Self_Advice',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Source1.Permission_To_Use_Exam1_Self_Advice'
        db.add_column('mydata_source1', 'Permission_To_Use_Exam1_Self_Advice',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Source1.Exam_1_Prep_Resources__0'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__0')

        # Deleting field 'Source1.Exam_1_Prep_Resources__1'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__1')

        # Deleting field 'Source1.Exam_1_Prep_Resources__2'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__2')

        # Deleting field 'Source1.Exam_1_Prep_Resources__3'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__3')

        # Deleting field 'Source1.Exam_1_Prep_Resources__4'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__4')

        # Deleting field 'Source1.Exam_1_Prep_Resources__6'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__6')

        # Deleting field 'Source1.Exam_1_Prep_Resources__7'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__7')

        # Deleting field 'Source1.Exam_1_Prep_Resources__8'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__8')

        # Deleting field 'Source1.Exam_1_Prep_Resources__9'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__9')

        # Deleting field 'Source1.Exam_1_Prep_Resources__10'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Resources__10')

        # Deleting field 'Source1.Exam_1_Prep_Simulation'
        db.delete_column('mydata_source1', 'Exam_1_Prep_Simulation')

        # Deleting field 'Source1.Permission_To_Use_Exam_1_Self_Advice'
        db.delete_column('mydata_source1', 'Permission_To_Use_Exam_1_Self_Advice')
    ...
    models = {
        ...
        'mydata19.source1': {
            ...
            'Exam_1_Prep_Resources__0': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__1': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__10': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__2': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__3': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__4': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__6': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__7': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__8': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Resources__9': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'Exam_1_Prep_Simulation': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'Method_1_Grade': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'Method_2_Grade': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'Permission_To_Use_Exam_1_Self_Advice': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'Sleep_Guess': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'Subject_Interest': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'Tailoring_Level': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
