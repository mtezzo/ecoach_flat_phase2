...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.Exam_RunningScore'
        db.add_column('mydata_source1', 'Exam_RunningScore',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.OWL_RunningScore'
        db.add_column('mydata_source1', 'OWL_RunningScore',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.Quiz_RunningScore'
        db.add_column('mydata_source1', 'Quiz_RunningScore',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.Exam_RunningScore'
        db.delete_column('mydata_source1', 'Exam_RunningScore')

        # Deleting field 'Source1.OWL_RunningScore'
        db.delete_column('mydata_source1', 'OWL_RunningScore')

        # Deleting field 'Source1.Quiz_RunningScore'
        db.delete_column('mydata_source1', 'Quiz_RunningScore')
