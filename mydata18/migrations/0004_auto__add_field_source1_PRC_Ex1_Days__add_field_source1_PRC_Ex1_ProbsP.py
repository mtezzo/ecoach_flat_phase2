...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source1.PRC_Ex1_Days'
        db.add_column('mydata_source1', 'PRC_Ex1_Days',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Source1.PRC_Ex1_ProbsPerDay'
        db.add_column('mydata_source1', 'PRC_Ex1_ProbsPerDay',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source1.PRC_Ex1_Days'
        db.delete_column('mydata_source1', 'PRC_Ex1_Days')

        # Deleting field 'Source1.PRC_Ex1_ProbsPerDay'
        db.delete_column('mydata_source1', 'PRC_Ex1_ProbsPerDay')
